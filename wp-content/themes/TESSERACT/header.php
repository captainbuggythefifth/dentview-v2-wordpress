...
<link rel="stylesheet" href="<?php echo get_template_directory_uri ()?>/custom/bootstrap-materialize/css/bootstrap-material-design.css">
<link rel="stylesheet" href="<?php echo get_template_directory_uri ()?>/custom/bootstrap-materialize/css/ripples.css">
<link rel="stylesheet" href="<?php echo get_template_directory_uri ()?>/custom/bootstrap/css/bootstrap.css">
...
<div id="page" class="hfeed site">
    ...
    <header id="masthead" class="site-header drop-shadow bottom <?php echo $rightclass . $headpos . ' ' . 'menusize-' . $hmenusize_class . ' '; echo get_header_image() ? 'is-header-image' : 'no-header-image'; ?>" role="banner">
