...
<?php wp_footer(); ?>
<script type="text/javascript" src="<?php echo get_template_directory_uri ()?>/custom/custom.js"></script>
<!--<script type="text/javascript" src="<?php /*echo get_template_directory_uri ()*/?>/custom/jquery-2.2.1.min.js"></script>
<script src="//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php /*echo get_template_directory_uri ()*/?>/custom/bootstrap/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php /*echo get_template_directory_uri ()*/?>/custom/bootstrap-materialize/js/material.min.js"></script>
<script type="text/javascript" src="<?php /*echo get_template_directory_uri ()*/?>/custom/bootstrap-materialize/js/ripples.min.js"></script>
<script type="text/javascript" src="<?php /*echo get_template_directory_uri ()*/?>/custom/custom.js"></script>
<script>
	$(function () {
		$.material.init();
